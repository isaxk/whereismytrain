...
<div class="flex flex-col gap-2 pt-5">
	<div class="flex items-center gap-2 border-b border-border pb-2">
		...
		<Input bind:value={time} type="time" class="w-16" />
		<div class="grow"></div>
	...
	<div class="flex items-center gap-2">
		...
		<Autocomplete bind:value={from} placeholder="Enter origin..." />
	</div>
	{#each changes as change, i (i)}
		<div class="flex items-center gap-2">
			...
			<Autocomplete bind:value={changes[i]} placeholder="Enter change point {i + 1}..." />
			{#if changes.length > 1}
	...
	<div class="flex items-center gap-2">
		...
		<Autocomplete bind:value={to} placeholder="Enter destination..." />
	</div>
